...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="범죄도시4 | 영화 그 이상의 감동. CGV"></meta>
    ...
    <title id="ctl00_headerTitle">[범죄도시4]&lt;영화상세 &lt; 영화 | 영화 그 이상의 감동. CGV</title>
			...
			<div class="header_content">
				<div class="contents">
					...
					<ul class="memberInfo_wrap">
						...
						<li><a
							href="/user/login/?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fmovies%2fdetail-view%2fdefault.aspx%3fmidx%3d88104"><img
		...
		<article class="company_info_wrap">
			<section class="company_info">
				...
				<dl class="company_info_list">
					...
					<dt>통신판매업신고번호</dt>
					<dd>
						1998-경기수원-0513 <a href="#none" onclick="goFtc()" class="btn_goFtc">사업자정보확인<a></a></a>
					</dd>
				</dl>
