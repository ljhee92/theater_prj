...
<script type="text/javascript">
    ...
    window.onload = function() {
        document.getElementById("findId_btn").addEventListener("click", function() {
            // 팝업 창 크기 설정
            var popupWidth = 600;
            var popupHeight = 400;
            // 팝업 창 가운데로 띄우기
            ...
            window.open("findIdResult.jsp", "_blank", "width=600,height=400,left=" + left + ",top=" + top);
        });
    };
</script>
</head>
...
<div class="wrap_findId">
    <h2 style="font-size: 24px; margin-bottom: 20px;">아이디 찾기</h2>
    <form>
        <div class="input-group mb-3 input-group-lg">
            <input type="text" class="form-control" id="findId_name" placeholder="이름을 입력하세요.">
        </div>
        <div class="input-group mb-3 input-group-lg">
            <input type="text" class="form-control" id="findId_birth" placeholder="생년월일 6자리를 입력하세요.">
        </div>
        <div class="input-group mb-3 input-group-lg">
            <input type="text" class="form-control" id="findId_tel" placeholder="전화번호 11자리를 입력하세요. (숫자만)">
        </div>
