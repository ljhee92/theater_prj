...
<script type="text/javascript" nonce="098ccc562cfd47e3818f4632ea5" src="//local.adguard.org?ts=1713490445734&amp;name=AdGuard%20Extra&amp;name=AdGuard%20Popup%20Blocker&amp;type=user-script"></script><script type="application/ld+json">
    {
...
<div class="header_content">
    <div class="contents">
        <h1 onclick=""><a href="/"><img src="IMG\명화관.png" alt="CGV" /></a><span>CULTUREPLEX</span></h1>
        <ul class="memberInfo_wrap">
            ...
            <li><a href="/user/mycgv/"><img src="https://img.cgv.co.kr/R2014/images/common/ico/loginMember.png" alt="MY CGV" /><span>MY 명화관</span></a></li>
        </ul>
    </div>
</div>
...
<!-- 실컨텐츠 시작 -->
    <div class="wrap-movie-chart">
        ...
        <%-- 4행 5열 반복문 시작 --%>
        <%
            int numMovies = 20; // 총 영화 수
            int numCols = 5;    // 열 개수
            
            for (int i = 0; i < numMovies; i++) {
                if (i % numCols == 0) { // 새로운 행 시작
        %>
        <%      }
        %>
        <li>
            ...
            <div class="box-contents">
                <a href="/movies/detail-view/?midx=88104">
                    <strong class="title">범죄도시4</strong>
                </a>
                <div class="score">
                    <strong class="percent">예매율<span>68.9%</span></strong>
                ...
                <span class="like"> 
                    <a class="link-reservation" href="/ticket/?MOVIE_CD=20035938&MOVIE_CD_GROUP=20035938">예매</a>
                </span>
            </div>    
        </li>
        <%-- 4행 5열 반복문 종료 --%>
